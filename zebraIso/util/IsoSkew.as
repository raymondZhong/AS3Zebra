package zebraIso.util
{
	...
	public class IsoSkew extends Sprite
	{
		 ...
		 */
		public function IsoSkew(imageBitmap:BitmapData, vP:Number=4, hP:Number=4)
		{
...
//			_imageBitmap = BitmapData(new classRef(0, 0));
		...
		public function setTransformPoints(p0:Point, p1:Point, p2:Point, p3:Point):void {
			  setTransform(p0.x, p0.y, p1.x, p1.y, p2.x, p2.y, p3.x, p3.y);
			}
