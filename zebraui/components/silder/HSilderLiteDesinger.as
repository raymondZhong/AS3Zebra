package zebraui.components.silder
{
	...
	internal class HSilderLiteDesinger extends AbstractSilder
	{
		...
		public function HSilderLiteDesinger()
		{
			super()
			var normal:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.HSilderLite.Block.Normal") 
			var hover:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.HSilderLite.Block.Hover") 
			var down:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.HSilderLite.Block.Down")
			var blockRect:Rectangle = UIFramework.resource.getElementRectangle("HSilderLite", "Block");
			...
			var bottomRect:Rectangle = UIFramework.resource.getElementRectangle("HSilderLite", "Bottom");			
			bottomContainer = new Scale9GridBitmap(UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.HSilderLite.Bottom"), bottomRect);
