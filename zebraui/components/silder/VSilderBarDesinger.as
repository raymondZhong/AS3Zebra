package zebraui.components.silder
{
	...
	internal class VSilderBarDesinger extends AbstractSilder
	{
		...
		public function VSilderBarDesinger()
		{
			super()
			var normal:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.VSilderBar.Block.Normal")
			var hover:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.VSilderBar.Block.Normal")
			var down:BitmapData = UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.VSilderBar.Block.Normal")
			var blockRect:Rectangle = UIFramework.resource.getElementRectangle("VSilderBar", "Block");
			...
			var bottomRect:Rectangle = UIFramework.resource.getElementRectangle("VSilderBar", "Bottom");
			bottomContainer = new Scale9GridBitmap(UIFramework.resource.getBitmapData("UIComponent.DefaultTheme.VSilderBar.Bottom"), bottomRect);
